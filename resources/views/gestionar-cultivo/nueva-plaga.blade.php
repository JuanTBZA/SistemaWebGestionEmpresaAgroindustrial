    ...
    <div class="flex flex-col lg:flex-row min-h-screen bg-gray-200">
        ...
        <div class="flex-1 flex flex-col overflow-x-hidden overflow-y-auto p-6">
            ...
            <nav class="text-sm mb-4">
                ...
                <span class="text-gray-700">Registrar Plagas > </span>
                <span class="text-gray-700">Nueva Plaga</span>
            </nav>
                

            <h1 class="text-2xl lg:text-3xl font-semibold mb-6">Nueva Plaga</h1>


            <div class="flex-1 flex flex-col lg:flex-row mb-6">
        
                <!-- Formulario de registro de labores -->
                <form action="{{ route('grabarPlaga')}}" method="POST" class="max-w-md mb-6 lg:mr-6">
                @csrf 

                    <!-- Nombre  -->
                    <div class="mb-4">
                        <label for="NombrePlaga" class="block text-sm font-medium text-gray-700">Nombre de la plaga</label>
                        <input type="text" name="NombrePlaga" id="NombrePlaga" class="mt-1 p-2 w-full border-gray-300 border rounded-md" required>
                    </div>
                    ...
                    <!-- Botón de enviar -->
                    <div class="mb-4">
                        <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-400 transition-colors duration-300">Registrar Plaga</button>
                    </div>
                </form>
